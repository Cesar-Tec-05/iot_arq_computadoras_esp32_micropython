# Importaciones necesarias para controlar un servo usando PWM en MicroPython.
import machine
import math

"""
Libreria de control de servos para MicroPython, compatible con ESP32 y otros microcontroladores.
"""
class Servo:
	def __init__(
		self,
